...
namespace Lean.Touch
{
    ...
    public class LeanMultiUpdate : MonoBehaviour
    {
        ...
        public ConstrainType Constrain { set { constrain = value; } get { return constrain; } }
        [SerializeField] private ConstrainType constrain;

        /// <summary>This finger(s) must move this many scaled pixels for the constraint to begin.</summary>
        public float ConstrainThreshold { set { constrainThreshold = value; } get { return constrainThreshold; } }
        [SerializeField] private float constrainThreshold = 5.0f;
